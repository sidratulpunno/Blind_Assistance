...
class ObjectDetectorPainter extends CustomPainter {
  ObjectDetectorPainter(
    ...
    required this.objectDistances, // Add this parameter
  });
  ...
  final Map<DetectedObject, double> objectDistances; // Add this field
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final DetectedObject detectedObject in _objects) {
      ...
      if (detectedObject.labels.isNotEmpty) {
        ...
        final distance = objectDistances[detectedObject] ?? 0.0; // Get distance
        builder.addText(
            '${label.text} ${label.confidence}\nDistance: ${distance.toStringAsFixed(2)} feet'); // Display distance
      }
      builder.pop();
